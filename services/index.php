...
<?php require_once("../php/partials/header.php");?>
	...
	<div id="webDesign" class="container bg-white page-top">
	...
	<div id="photography" class="container bg-white">
		<div class="row py-5 my-5">
			<div class="col-s-12 col-md-6 col-lg-4 text-dark pr-5">
				...
				<p class="font-weight-bold">Korigan Design provides high quality commercial photography & video production, the key to staying ahead and staying connected. We capture images. We are photographers, filmmakers, storytellers. We produce superior photo and video content for your advertising, marketing and promotional needs. We’re a hands-on with every client. We’re a small team. We’re artists and entrepreneurs, supporters of our local community, world travelers and appreciate family time. We’re always plugged in. We like tech. We love art. And dance. And music. And film. We deliver photography and video content you can use. <a href="<?php echo $PREFIX;?>contact/index.php" class="service-contact-link">Contact us</a> today for a no obligation consultation.</p>
			</div>
			<div class="col-s-12 col-md-6 col-lg-8">
	...
	<div  id="graphicDesign" class="container bg-white">
		<div class="row py-5 my-5">
			<div class="col-s-12 col-md-6 col-lg-8">
